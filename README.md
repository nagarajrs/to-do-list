...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/to-do#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/to-do
```

A live public deployment of this template is available at [https://to-do.templates.workers.dev](https://to-do.templates.workers.dev)
